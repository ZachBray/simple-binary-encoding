...
private:
    ...
    enum class CodecState
    {
        ...
        V0_PERFORMANCEFIGURES_N = 6,
        V0_PERFORMANCEFIGURES_N_BLOCK = 7,
        V0_PERFORMANCEFIGURES_1_BLOCK = 8,
        V0_PERFORMANCEFIGURES_DONE = 9,
        V0_PERFORMANCEFIGURES_N_ACCELERATION_N = 10,
        V0_PERFORMANCEFIGURES_N_ACCELERATION_N_BLOCK = 11,
        V0_PERFORMANCEFIGURES_N_ACCELERATION_1_BLOCK = 12,
        V0_PERFORMANCEFIGURES_N_ACCELERATION_DONE = 13,
        V0_PERFORMANCEFIGURES_1_ACCELERATION_N = 14,
        V0_PERFORMANCEFIGURES_1_ACCELERATION_N_BLOCK = 15,
        V0_PERFORMANCEFIGURES_1_ACCELERATION_1_BLOCK = 16,
        V0_PERFORMANCEFIGURES_1_ACCELERATION_DONE = 17,
        V0_MANUFACTURER_DONE = 18,
        V0_MODEL_DONE = 19,
    };

    static const std::string STATE_NAME_LOOKUP[20];
    static const std::string STATE_TRANSITIONS_LOOKUP[20];
...
public:
    ...
    {
        Car skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion, m_codecState);
        skipper.skip();
...
private:
    void onSerialNumberAccessed() const
    {
...
public:
    ...
    SBE_NODISCARD std::uint32_t serialNumber() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
    ...
    Car &serialNumber(const std::uint32_t value)
    {
...
private:
    void onModelYearAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
...
public:
    ...
    SBE_NODISCARD std::uint16_t modelYear() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onModelYearAccessed();
#endif
...
private:
    void onAvailableAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
...
public:
    ...
    SBE_NODISCARD std::uint8_t availableRaw() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onAvailableAccessed();
#endif
...
public:
    ...
    SBE_NODISCARD char codeRaw() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onCodeAccessed();
#endif
...
private:
    void onSomeNumbersAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
...
public:
    ...
    SBE_NODISCARD const char *someNumbers() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
    ...
    SBE_NODISCARD char *someNumbers()
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onSomeNumbersAccessed();
#endif
    ...
    Car &putSomeNumbers(const char *const src)
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onSomeNumbersAccessed();
#endif
...
private:
    void onVehicleCodeAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
...
public:
    ...
    SBE_NODISCARD const char *vehicleCode() const
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
    ...
    SBE_NODISCARD char *vehicleCode()
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onVehicleCodeAccessed();
#endif
    ...
    Car &putVehicleCode(const char *const src)
    {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onVehicleCodeAccessed();
#endif
...
public:
    ...
    public:
        ...
        SBE_NODISCARD std::uint16_t speed() const
        {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
            onSpeedAccessed();
#endif
...
private:
    void onFuelFiguresAccessed(std::uint64_t remaining, std::string action)
    {
        if (0 == remaining)
        {
            switch (codecState())
...
public:
    ...
    {
        m_fuelFigures.wrapForDecode(m_buffer, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onFuelFiguresAccessed(m_fuelFigures.count(), "decode");
#endif
    ...
    {
        m_fuelFigures.wrapForEncode(m_buffer, count, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
    ...
    private:
        void onOctaneRatingAccessed() const
        {
            switch (codecState())
            {
    ...
    public:
        ...
        SBE_NODISCARD std::uint8_t octaneRating() const
        {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        ...
        public:
            ...
            SBE_NODISCARD std::uint16_t mph() const
            {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
                onMphAccessed();
#endif
        ...
        public:
            ...
            SBE_NODISCARD float seconds() const
            {
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
                onSecondsAccessed();
#endif
...
public:
    ...
    private:
        void onAccelerationAccessed(std::uint64_t remaining, std::string action)
        {
            if (0 == remaining)
            {
                switch (codecState())
    ...
    public:
        ...
        {
            m_acceleration.wrapForDecode(m_buffer, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
            onAccelerationAccessed(m_acceleration.count(), "decode");
#endif
        ...
        {
            m_acceleration.wrapForEncode(m_buffer, count, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
...
private:
    void onPerformanceFiguresAccessed(std::uint64_t remaining, std::string action)
    {
        if (0 == remaining)
        {
            switch (codecState())
...
public:
    ...
    {
        m_performanceFigures.wrapForDecode(m_buffer, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
        onPerformanceFiguresAccessed(m_performanceFigures.count(), "decode");
#endif
    ...
    {
        m_performanceFigures.wrapForEncode(m_buffer, count, sbePositionPtr(), m_actingVersion, m_bufferLength, codecStatePtr());
#if defined(ENABLE_ACCESS_ORDER_CHECKS)
...
private:
    void onManufacturerLengthAccessed() const
    {
        switch (codecState())
        {
            case CodecState::V0_PERFORMANCEFIGURES_DONE:
...
private:
    void onModelLengthAccessed() const
    {
        switch (codecState())
        {
...
const std::string Car::STATE_NAME_LOOKUP[20] =
{
    "NOT_WRAPPED",
    "V0_BLOCK",
    "V0_FUELFIGURES_N",
...
const std::string Car::STATE_TRANSITIONS_LOOKUP[20] =
{
    "\"wrap(version=0)\"",
