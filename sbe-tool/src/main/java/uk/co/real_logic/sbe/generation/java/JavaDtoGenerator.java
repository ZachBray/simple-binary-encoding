...
public class JavaDtoGenerator implements CodeGenerator
{
    ...
    public void generate() throws IOException
    {
        ...
        for (final List<Token> tokens : ir.messages())
        {
            ...
            final ClassBuilder classBuilder = new ClassBuilder(dtoClassName, BASE_INDENT, "final");
        ...
        final String indent)
    {
        for (int i = 0, size = tokens.size(); i < size; i++)
        {
            ...
            final ClassBuilder groupClassBuilder = new ClassBuilder(groupClassName, indent, "static final");
        ...
        for (int i = 0, size = varDataTokens.size(); i < size; i++)
        {
            ...
            if (token.signal() == Signal.BEGIN_VAR_DATA)
            {
                ...
                lengthBuilder.append(indent).append(INDENT).append("encodedLength += ")
                    ...
                    .append(varDataToken.encoding().primitiveType().size()).append(";\n\n");
    ...
    private void generateComposite(final List<Token> tokens) throws IOException
    {
        ...
        try (Writer out = outputManager.createOutput(className))
        {
            ...
            final ClassBuilder classBuilder = new ClassBuilder(className, BASE_INDENT, "final");
