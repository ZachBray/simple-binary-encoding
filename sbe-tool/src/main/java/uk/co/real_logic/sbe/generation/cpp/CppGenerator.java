...
{
    private static final boolean GENERATE_IMPLICIT_COPY_CONSTRUCTORS = Boolean.parseBoolean(
        System.getProperty("sbe.generate.implicit.copy.constructors", "false"));
    ...
    {
        return GENERATE_IMPLICIT_COPY_CONSTRUCTORS ? "" :
            String.format(
                "#if __cplusplus >= 201103L\n" +
