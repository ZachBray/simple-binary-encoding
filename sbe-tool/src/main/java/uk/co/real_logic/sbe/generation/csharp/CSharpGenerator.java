        ...
        final String indent)
    {
        ...
        for (int i = 0, size = tokens.size(); i < size; i++)
        {
            ...
            if (token.signal() == Signal.BEGIN_VAR_DATA)
            {
                ...
                final CharSequence lengthAccessOrderListenerCall =
                    generateAccessOrderListenerCall(accessOrderModel, indent + INDENT, accessOrderListenerMethodName(token, "Length"));
